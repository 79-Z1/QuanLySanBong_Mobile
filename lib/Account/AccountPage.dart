                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 20,),
                                      Container(height: 50,
                                        child: Text("${list.taiKhoan!.HoTen}",
                                          style: TextStyle(
                                            fontSize: 22,
                                            fontWeight: FontWeight.bold,
                                          ),
                                      ...
                                      SizedBox(height: 20,),
                                      Container(height: 50,
                                        child: Text("${list.taiKhoan!.DiaChi}",
                                          style: TextStyle(
                                            fontSize: 22,
                                            fontWeight: FontWeight.bold,
                                          ),
                                      ...
                                      SizedBox(height: 20,),
                                      Container(height: 50,
                                        child: Text("${list.taiKhoan!.Email}",
                                          style: TextStyle(
                                            fontSize: 22,
                                            fontWeight: FontWeight.bold,
                                          ),
                                      ...
                                      SizedBox(height: 20,),
                                      Container(height: 50,
                                        child: Text("${list.taiKhoan!.Vip==true?'VIP':'Thường'}",
                                          style: TextStyle(
                                            fontSize: 22,
                                            fontWeight: FontWeight.bold,
                                          ),
                                      ...
                                      SizedBox(height: 20,),
                                      Container(height: 50,
                                        child: Text("${list.taiKhoan!.DiemTich}",
                                          style: TextStyle(
                                            fontSize: 22,
                                            fontWeight: FontWeight.bold,
                                          ),
